<?php if ( comments_open() ) : ?>
    ...
    <!-- Kommentar eingeben -->
            ...
            <h3><?php _e( 'Write Comment.', 'understrap-bs3' ); ?> <small class="text-danger"><?php _e( '*Mandatory', 'understrap-bs3' ); ?></small></h3>
            ...
            <form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform" role="form">
                ...
                <div class="form-group">
                    <label for="author"><?php _e( 'Name', 'understrap-bs3' ); ?> <small class="text-danger">*</small></label>
                    <input class="form-control" type="text" name="author" id="author" value="<?php echo $comment_author; ?>" size="22"/>
                </div>

                <hr/>
                <div class="form-group">
                    <label for="email"><?php _e( 'E-Mail', 'understrap-bs3' ); ?> <small>( <?php _e( 'Not public.', 'understrap-bs3' ); ?> )</small><small class="text-danger">*</small></label>
                    <input class="form-control" type="email" name="email" id="email" value="<?php echo $comment_author_email; ?>" size="22" tabindex="2"/>
                </div>
                <hr/>
                <div class="form-group">
                    <label for="url"><?php _e( 'Website', 'understrap-bs3' ); ?></label>
                    <input class="form-control" type="url" name="url" id="url" value="<?php echo $comment_author_url; ?>" size="22" tabindex="3" />
                </div>
                <hr/>
                <div class="form-group">
                    <label><?php _e( 'Your Comment', 'understrap-bs3' ); ?> <small class="text-danger">*</small></label>
                ...
                <div class="form-group  text-center">
                    <input class="form-control btn btn-primary" name="submit" type="submit" id="submit" tabindex="5" value="<?php _e( 'Send comment.', 'understrap-bs3' ); ?>" />
